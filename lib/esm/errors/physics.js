...
export class UniqKeyPhysicsError extends BasePhysicsError {
  constructor(termName = '', termParentName = '', physicsPath = '') {
    super([PHYSIC_COLUMN_NAMES.parentTermName, PHYSIC_COLUMN_NAMES.termName, PHYSIC_COLUMN_NAMES.physicPath].join(','), 'ERR-100  Не уникальное сочетание родительского термина и термина', termName, termParentName, physicsPath);
  }
...
export class ParentTermDuplicatePhysicError extends BasePhysicsError {
  constructor() {
    super(PHYSIC_COLUMN_NAMES.parentTermName, 'ERR-104 В Alation существует два родительских термина с данным' + ' названием - исправьте перед загрузкой данного файла');
  }
