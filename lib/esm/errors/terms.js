...
export class ParentTermNotFoundTermError extends BaseTermError {
  constructor(termName = '', termParentName = '') {
    super(termName, termParentName, 'Родительский термин', 'ERR-006 Родительский термин не существует');
  }

}
export class ParentTermDuplicateTermError extends BaseTermError {
  constructor(termName = '', termParentName = '') {
    super(termName, termParentName, 'Родительский термин', 'ERR-007 В Alation существует два родительских термина с данным' + ' названием - исправьте перед загрузкой данного файла');
  }

}
export class TermNotFoundTermError extends BaseTermError {
  constructor(termName = '', termParentName = '') {
    super(termName, termParentName, 'Термин', 'ERR-008 Термин не существует');
  }
