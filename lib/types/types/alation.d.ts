...
export interface ITermArticle extends IArticle<AlternativeNameCustomField | ReferenceCustomField | LineageRefCustomField | LineageTableCustomField> {
}
...
export declare type LinkCustomFieldValue = {
    'display_name': string;
    'id': AlationEntityId;
    'oid': AlationEntityId;
    'otype': ObjectType;
...
//# sourceMappingURL=alation.d.ts.map